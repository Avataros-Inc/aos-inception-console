...
// CSS for the sidebar and content with AVATAROS theme
const styles = {
  container: {
    display: 'flex',
    minHeight: '100vh'
...
// Sidebar component with AVATAROS styling
const Sidebar = () => {
  return (
...
// Home Page Component with AVATAROS styling
const HomePage = () => {
    ...
    <div className='p-6'>
      <div className='mb-6'>
        ...
        <p className='text-text-secondary text-lg'>
          The future of AI-powered avatar creation and interaction
        </p>
      </div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8'>
        ...
        <Card className='glass-effect'>
          ...
          <Card.Body>
            <p className='text-text-secondary mb-3'>
              Transform text and audio into expressive avatar content
            </p>
            <Button variant='primary' size='sm'>
              Explore Tools
            </Button>
        ...
        <Card className='glass-effect'>
          ...
          <Card.Body>
            <p className='text-text-secondary mb-3'>
              Deploy conversational AI avatars across any platform
            </p>
            <Button variant='primary' size='sm'>
              Deploy Now
            </Button>
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route
          path='/reset-password'
          element={!session ? <ResetPassword /> : <Navigate to='/console' />}
        />
        <Route
          path='/console/*'
          element={session ? <Console session={session} /> : <Navigate to='/login' />}
        />
