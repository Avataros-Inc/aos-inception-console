...
import { ArrowLeft, ArrowRight, ArrowUp, ArrowDown, ZoomIn, ZoomOut, ArrowCounterclockwise, CameraReels } from 'react-bootstrap-icons';
  ...
  return (
    <Container className="d-flex justify-content-center flex-column">
      <Row className="flex-grow-1 m-0" style={{ position: 'relative' }}>
        ...
        <Col className="d-flex justify-content-center mb-3 align-items-center">
                  <Button variant='outline-secondary' size="sm" onClick={() => handleButtonDown('Preset1')}>Preset1</Button>
                  <Button variant='outline-secondary' size="sm" onClick={() => handleButtonDown('Preset2')}>Preset2</Button>
                  <Button variant='outline-secondary' size="sm" onClick={() => handleButtonDown('Preset3')}>Preset3</Button>
                  <Button variant='outline-secondary' size="sm" onClick={() => handleButtonDown('Preset4')}>Preset4</Button>
                  </Col>
      </Row>
    </Container>
  );
