...
export const AlphaCard = () => {
  return (
    <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-8 shadow-xl text-center">
      <h2 className="text-4xl font-bold text-slate-300 mb-3">
        <span
      ...
      <p className="text-slate-400 mb-6">
        Please report issues to: <strong className="text-slate-300">tech@avataros.com</strong>
      </p>
      <div className="text-sm text-slate-500 pt-4 border-t border-slate-700">Under active development</div>
    </div>
  );
};
