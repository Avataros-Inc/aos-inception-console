...
import AvatarPixelStreaming from './AvatarPixelStreamingStub.jsx';
  ...
  if (sessionId) {
    return (
      <div className="relative w-full h-screen">
        ...
        <AvatarPixelStreaming sessionId={sessionId} authToken={getSessionToken()} apiBaseUrl={API_BASE_URL} />
